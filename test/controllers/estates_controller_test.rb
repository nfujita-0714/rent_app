...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { adress: @estate.adress, content: @estate.content, name: @estate.name, price: @estate.price, year: @estate.year } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { adress: @estate.adress, content: @estate.content, name: @estate.name, price: @estate.price, year: @estate.year } }
